        ...
        rows: rows.map((row) => DataRow(cells: [
          ...
          for (final pct in row.weeks)
            DataCell(Container(
              ...
              child: Text('$pct', style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w600)),
            )),
        ])).toList(),
      ),
    );
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('AVG BAND GAIN', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 1.2, color: MagazineColors.mastheadGoldText)),
              ],
            ),
          ),
        ],
