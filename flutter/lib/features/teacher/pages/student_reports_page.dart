...
class _StudentReportsPageState extends State<StudentReportsPage> {
        ...
        content: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('You must be logged in to the hub (cookie sent automatically).'),
            ],
          ),
        ),
        actions: [
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Student Reports'), actions: [
                    ...
                    children: [
                      if (_classrooms?.isEmpty ?? true)
                        Card(
                          child: Padding(
                            padding: const EdgeInsets.all(16),
                            child: Text('No classrooms yet. Create one first.',
                          ...
                          Card(
                            child: ExpansionTile(
                              ...
                              children: [
                                ...
                                for (final s in (cr['students'] as List?) ?? <dynamic>[])
                                  ListTile(
