  ...
  Future<void> _load() async {
    ...
    try {
      ...
      _primaryColorController.text =
          (branding?['primary_color'] as String?) ?? '#CCFF00';
      _customSubdomainController.text =
          (branding?['custom_subdomain'] as String?) ?? '';
      _customCopyrightController.text =
          (branding?['custom_copyright'] as String?) ?? '';
    ...
    try {
      ...
      await dio.put(
        ...
        data: {
          ...
          'custom_subdomain': _customSubdomainController.text.trim().isEmpty
              ? null
              : _customSubdomainController.text.trim(),
          'custom_copyright': _customCopyrightController.text.trim().isEmpty
              ? null
              : _customCopyrightController.text.trim(),
        ...
        : ListView(
              ...
              children: [
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (_data?['tier'] != null)
                          ...((_data!['tier'] as Map)['features'] as List).map(
                            (f) => ListTile(
                              leading: const Icon(
                                Icons.check,
                                color: Colors.green,
                ...
                SwitchListTile(
                  ...
                  subtitle: const Text(
                    'Only available on Pro/Institution tier',
                  ),
                  value: _hideBranding,
