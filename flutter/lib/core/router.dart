...
import '../features/teacher/pages/student_progress_page.dart' as teacher;
...
final routerProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/teacher/progress/:classroomId', builder: (c, s) => teacher.StudentProgressPage(classroomId: s.pathParameters['classroomId']!)),
